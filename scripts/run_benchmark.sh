...
BENCH_PROMPT_PATH="benchmark_data/benchmark_prompts.json"
CONFIG="config/config_group_scales.yaml"

TRAIN_DATA_DIR="benchmark_data/test" # specify the path to the training data
OUTPUT_EVAL_DIR="output/test" # specify the path to the output directory
