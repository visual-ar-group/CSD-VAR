...
# Code adapted from:
# https://github.com/yandex-research/switti/blob/master/models/__init__.py

import torch.nn as nn

from .clip import FrozenCLIPEmbedder
from .pipeline import SwittiDisentangledPipeline, SwittiPipeline
from .switti import Switti, SwittiHF
...
def build_models(
    ...
    if pretrained_path is None:
        ...
        switti_wo_ddp = SwittiHF.from_pretrained(
            pretrained_path,
            depth=depth,
            rope=rope,
            rope_theta=rope_theta,
...
def build_models_disentangled(
    ...
    text_encoder_2 = FrozenCLIPEmbedder(text_encoder_2_path, freeze=freeze_text_encoder)
    vae_local = VQVAEHF.from_pretrained("yresearch/VQVAE-Switti").to(device)
    pipe = SwittiDisentangledPipeline(
        switti_wo_ddp,
        vae_local,
        text_encoder,
        text_encoder_2,
